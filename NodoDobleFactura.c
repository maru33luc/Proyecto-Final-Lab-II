...
Registro_Factura cargarUnRegistroFactura (Registro_Factura a, nodoSimpleEmpresa *lista)
{
    ...
    do
    {
        ...
        if(strlen(a.nombreEmpresa)==0)
            ...
            if(strlen(a.nombreEmpresa)<3)flag =1;
    }
    while(flag==1);

    do
    {
        printf("\nIngrese si es emitida por un proveedor ('p') o hacia un cliente ('c'):\n");
        fflush(stdin);
        scanf("%c",&a.cp);
    ...
    do
    {
        ...
        if(strlen(a.cuit_cliente_proveedor)!=11){
              flag = 1;
            }
    }
    while(flag==1);
    ...
    else
    {
        ...
        do
        {
            ...
            if(strcmpi(a.comprobante,"Recibo")!=0 && strcmpi(a.comprobante,"Factura") != 0&& strcmpi(a.comprobante,"Nota Credito") != 0){
              flag = 1;
            }
        }
        while(flag==1);
        ...
        do
        {
            ...
            fflush(stdin);
            scanf("%d",&a.fecha.mes);
            printf("\nIngrese el anio de la Factura: (1980-2030)\n");
            fflush(stdin);
        ...
        do
        {
            ...
            if(strlen(a.nombre_cliente_proveedor)<3)flag =1;
        }
        while(flag==1);
